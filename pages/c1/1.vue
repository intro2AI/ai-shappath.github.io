<template>
	<div class="page">
		...
		<main>
			<div class="content">
				<p><br />
					In this section we will immerse ourselves into Generative AI Chatbots, also known as Large Language Models(LLMs).
					We will understand through examples, the kinds of tasks an LLM is capable of doing, and how you can fit LLMs into workflows and processes in your domain of interest.
					<br /></p>
